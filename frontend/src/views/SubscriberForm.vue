        ...
        <div class="columns">
          <div class="column is-4">
            <b-field :label="$t('subscribers.firstName')" label-position="on-border">
              <b-input :maxlength="200" v-model="form.firstname" name="firstname"
                :placeholder="$t('subscribers.firstName')" data-cy="firstname" />
            </b-field>
          </div>
          <div class="column is-4">
            <b-field :label="$t('subscribers.lastName')" label-position="on-border">
              <b-input :maxlength="200" v-model="form.lastname" name="lastname"
                :placeholder="$t('subscribers.lastName')" data-cy="lastname" />
            </b-field>
          </div>
          <div class="column is-4">
            <b-field :label="$t('subscribers.company')" label-position="on-border">
              <b-input :maxlength="200" v-model="form.company" name="company"
                :placeholder="$t('subscribers.company')" data-cy="company" />
            </b-field>
          </div>
        </div>
...
export default Vue.extend({
  ...
  methods: {
    ...
    buildAttribs() {
      ...
      return this.$utils.mergeSubscriberAttribs(attribs, this.form);
    },
  ...
  mounted() {
    if (this.$props.isEditing) {
      const attribs = this.$props.data.attribs || {};
      this.form = {
        ...this.$props.data,
        firstname: this.$utils.subscriberAttrib(attribs, 'firstname'),
        lastname: this.$utils.subscriberAttrib(attribs, 'lastname'),

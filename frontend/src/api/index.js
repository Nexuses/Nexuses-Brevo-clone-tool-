...
export const getSubscriber = async (id) => http.get(
  ...
  {
    loading: models.subscribers,
    camelCase: (keyPath) => !keyPath.startsWith('.attribs'),
  },
);
...
export const getCampaignAnalyticsRecords = async (type, params) => http.get(
  `/api/campaigns/analytics/records/${type}`,
  { params, loading: models.campaigns },
);
...
export const testCloudflare = async (data) => http.post(

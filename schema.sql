...
DROP TYPE IF EXISTS content_type CASCADE; CREATE TYPE content_type AS ENUM ('richtext', 'html', 'plain', 'markdown', 'visual', 'maily');
DROP TYPE IF EXISTS bounce_type CASCADE; CREATE TYPE bounce_type AS ENUM ('soft', 'hard', 'complaint');
DROP TYPE IF EXISTS template_type CASCADE; CREATE TYPE template_type AS ENUM ('campaign', 'campaign_visual', 'campaign_maily', 'tx');
...
INSERT INTO settings (key, value) VALUES
    ...
    ('messengers', '[]'),
    ('cloudflare_email', '{"enabled":false,"account_id":"","api_token":"","max_conns":10,"timeout":"10s","max_msg_retries":2}'),

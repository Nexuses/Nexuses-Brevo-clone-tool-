...
func main() {
	var (
		...
		// Initialize all messengers: SMTP, Cloudflare Email, and postback.
		msgrs = append(append(initSMTPMessengers(), initCloudflareMessenger(ko)...), initPostbackMessengers(ko)...)
